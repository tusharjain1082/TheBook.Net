...
namespace DiaryJournal.Net
{
    public partial class FormOperation : Form
    {
        ...
        public static FormOperation? showForm(Form? parent, String desc, long progress, long total, long filesDone, long totalFiles)
        {
        ...
        public void __close()
        {
            //var childForms = Application.OpenForms.OfType<FormOperation>().ToList();
