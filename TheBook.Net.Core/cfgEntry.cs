...
namespace DiaryJournal.Net
{
    public static class cfgEntry
    {
        ...
        public static bool fromCfg(ref Chapter chapter, Stream s)
        {
            // read entire file
            ...
            chapter.Id = UInt32.Parse(values[0]);
            chapter.parentId = UInt32.Parse(values[1]);
            ...
            try
            {
                chapter.guid = Guid.Parse(values[17]);
            }
            catch { }
        ...
        public static String toCfg(ref Chapter chapter)
        {
            ...
            body += String.Format(@"{0}:::" + Environment.NewLine, chapter.guid);
            return body;
        }
    }
}
