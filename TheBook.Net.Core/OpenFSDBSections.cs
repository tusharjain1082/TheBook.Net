...
namespace DiaryJournal.Net
{
    ...
    public class OpenFSDBSections
    {
        ...
        public const long maxNodesInSection = 50000; // 50,000 * 200 sections = 10000000 = 1 Crore files in 200 sections so this configuration is optimized
        ...
        public static bool createSections(OpenFSDBContext? ctx, long startingid, long total)
        {
            long id = startingid;
        ...
        public static OpenFSDBSection? createSection(OpenFSDBContext? ctx, long id)
        {
            ...
            ctx.dbSections.totalSections = ctx.dbSections.sections.LongCount();
            return section;
        }
        ...
        public static Int64 getTotalEntriesAllSections(OpenFSDBContext ctx)
        {
            // reload latest state
        ...
        public static bool loadReloadSections(OpenFSDBContext ctx)
        {
            ...
            Int64 id = 1; // 1 is valid section id and 0 is invalid
            foreach (String dir in Directory.EnumerateDirectories(ctx.dbEntryConfigPath))
            {
                DirectoryInfo dirInfo = new DirectoryInfo(dir);

                if (!Int64.TryParse(dirInfo.Name, out id)) continue;
        ...
        public static bool refreshSection(OpenFSDBContext ctx, OpenFSDBSection section)
        {
            ...
            long totalNodes = directoryInfo.GetFiles().Count();
