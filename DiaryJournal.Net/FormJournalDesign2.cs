...
namespace DiaryJournal.Net
{
    ...
    public partial class FormJournalDesign2 : Form
    {
        ...
        public bool reloadPath(String path, bool usePath, RegisterItem? item)
        {
            ...
            //currentItem = Register.LoadSetupRegisterItem(dbCtx, currentItem.Id, true, false, true, false, true, true);

            // load registry item's node config from entry file
            String rtf = "";
            byte[]? xamlbytesOut = null;
            currentItem = Register.LoadSetupRegisterItem(dbCtx, currentItem.Id, true, false, false, false, true, true);
            ...
            RegisterItem? root = Register.LoadSetupRegisterItem(dbCtx, 0, true, false, true, false, true, true);
        ...
        public bool reloadChildren(UInt32 id, ListView lv)
        {
            ...
            // phase 1 - firstly get the registry node item
            List<RegisterItem>? registry = null;
            if (!Register.LoadFullPath(dbCtx, id, ref registry, true))
                return false; // critical error abort
        ...
        public bool __processSearch()
        {
            ...
            */
            ...
            bool result = journalSearchFramework.searchEntries(dbCtx, null, this, txtSearchProgressFullPath, lvSearch, tsSearchProgressBar,
        ...
        public void MoveNode(UInt32 destId)
        {
            ...
            //setup
            currentPathItem = Register.LoadSetupRegisterItem(dbCtx, currentItem.Id, true, false, false, false, false, false);
        ...
        public bool cloneEntry(UInt32 id, UInt32 locationId)
        {
            if (!dbCtx.isDBOpen())
                return false; // error
        ...
        private void cloneAtParentLevelToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            RegisterItem? parent = null;
            if (Register.FindNode(dbCtx, currentPathItem.parentId, ref parent) < 0) return;
            if (parent == null) return;
        ...
        public void deleteNodes()
        {
            ...
            RegisterItem? item = Register.LoadSetupRegisterItem(dbCtx, currentPathItem.Id, false, false, false, false, true, true);
            this.emptySlotsItem = Register.LoadSetupRegisterItem(dbCtx, this.emptySlotsItem.Id, false, false, false, false, true, true);
        ...
        private void toolStripMenuItem3_Click(object sender, EventArgs e)
        {
            ...
            foreach (OpenFSDBSection section in dbCtx.dbSections.sections)
            {
                ...
                foreach (myNode? listNode in list)
                {
                    ...
                    RegisterItem? parent = Register.LoadSetupRegisterItem(dbCtx, node.chapter.parentId, false, false, false, false, true, true);
