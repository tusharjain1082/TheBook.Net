...
6. printing support.
7. export to html.
8. templates. create your own custom templates.
9. font formatting, font size, bold, italics, etc.
10. copy, paste, write, collect, organize texts. you can write myriads of books with myriads of chapters each in their own unique nodes/records with titles/names.
11. minimal optimized memory use.
12. most bugs fixed. a ready open source software with complete source code.
