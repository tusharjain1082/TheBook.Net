...
## open source
TheBook.Net source code is available. both application and source code licensed under GPL v3 open source license. i take no liability for anything and i am not responsible for any damage or loss or anything. please use them at your own responsibility and liability and risk. the source code is as is. you can compile it in Visual Studio 2026 and .Net 10.0. this source code is backwards compatible, can build on Visual Studio 2022 and .Net 8.0. precompiled executable binary application files are published in releases section.
